...
import { Button, Icon, Toolbar } from '../slatjs-components'
...
interface SlateElementWrap extends SlateElement {
  type: string
  align: string
}
...
export const RichTextExample = () => {
  ...
  return (
    <Slate editor={editor} initialValue={initialValue}>
      <div>
        <a href='https://www.slatejs.org/examples/richtext'>Examples</a>
      </div>
...
const toggleBlock = (editor: Editor, format: string) => {
  ...
  Transforms.unwrapNodes<CustomBaseElement>(editor, {
    match: (n: any) =>
      !Editor.isEditor(n) &&
  ...
  let newProperties: Partial<SlateElementWrap>
...
const isBlockActive = (editor: Editor, format: string, blockType = 'type') => {
  ...
  const [match] = Array.from(
    Editor.nodes<CustomBaseElement>(editor, {
      at: Editor.unhangRange(editor, selection),
      match: n =>
        !Editor.isEditor(n) &&
        SlateElement.isElement(n) &&
        (n as CustomBaseElement)[blockType] === format,
    })
  )
